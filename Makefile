...
APP?=k8s-workshop-demo
PROJECT=github.com/rkudlov/k8s-workshop-demo
...
K8SWORKSHOPDEMO_LOCAL_HOST?=0.0.0.0
K8SWORKSHOPDEMO_LOCAL_PORT?=8080
K8SWORKSHOPDEMO_LOG_LEVEL?=0
...
run: build
	@echo "+ $@"
	@docker run --name ${CONTAINER_NAME} -p ${K8SWORKSHOPDEMO_LOCAL_PORT}:${K8SWORKSHOPDEMO_LOCAL_PORT} \
		-e "K8SWORKSHOPDEMO_LOCAL_HOST=${K8SWORKSHOPDEMO_LOCAL_HOST}" \
		-e "K8SWORKSHOPDEMO_LOCAL_PORT=${K8SWORKSHOPDEMO_LOCAL_PORT}" \
		-e "K8SWORKSHOPDEMO_LOG_LEVEL=${K8SWORKSHOPDEMO_LOG_LEVEL}" \
